...
public class Main
{
    public static void main(String[] args)
    {
        ...
        Person p1=new Person("Julia", "Krzowska", LocalDate.of(2005, 1, 13));
        Person p2=new Person("Jan", "Opiła", LocalDate.of(2005, 8, 11));
        Person p3=new Person("Julia", "Opiła", LocalDate.of(2000, 1, 3));
